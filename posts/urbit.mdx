...
date: "2022-04-24"
description: "A Philosophical Introduction to Urbit: The Last Stack With a Soul"
---
...
To get on the network, you have two alternatives: You can either self-host, in which case I'll assume you're technical enough to figure it out. Or you can use a hosting provider, in which case you'll have to pay a monthly fee. I recommend [Holium Hosting](https://hosting.holium.com), mostly because I work there, but we're also the only hosting provider that allows you to join with an existing Urbit ID and pier.
