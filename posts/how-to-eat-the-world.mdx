...
Finishing the last 10% percent of a software project requires the hard-earned wisdom of knowing what work needs to be paced, and is thus what distinguishes experienced engineers from inexperienced such.
...
Early-stage startups need to do a lot with little, which means hiring generalist engineers with product and people skills. These go under many different names, but two common ones are [product engineer](https://memos.hawkhill.ventures/p/rise-of-the-product-engineer) and [founding engineer](https://basecase.vc/blog/founding-engineer).

But if you are going to hire more than one or two engineers, it is crucial that their skill sets are complementary. For example, if you are more of a backend engineer, hire a frontend engineer. If you know data, hire someone great with design. Whilst you want generalists in the broader sense, the risk with hiring engineers without any technical expertise is that you get a mix of good code and bad code living throughout the stack. It is far better to have one specialized engineer able to address each area of the stack.
