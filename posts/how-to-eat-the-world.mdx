---
title: "How to Eat The World"
date: "2023-06-29"
description: "5 Lessons in Startup Software Engineering"
---

Building excellent software is all about speed. Big technology companies have entire departments dedicated to “Engineering Productivity,” but best-practices at large engineering organizations with product-market fit are almost opposite to what's right for an early-stage startup. A large company should optimize for *reliability* because their biggest risk is losing customer trust, whereas a startup should optimize for *speed* because their biggest risk is running out of runway. Which is why successful startups figure out a way to ship and iterate – insanely fast. What follows are 5 principles startups should follow to produce software with *speed*.
...
Early-stage startups need to do a lot with little, which means hiring T-shaped engineers with product and people skills. This type of engineer go under many different names, but two common ones are [product engineer](https://memos.hawkhill.ventures/p/rise-of-the-product-engineer) and [founding engineer](https://basecase.vc/blog/founding-engineer).
