...
date: "2023-09-25"
description: "Moving Beyond the 20th Century"
image: "/frontier/bell-labs-ny-hq.png"
draft: true
---

Did we just shift innovation into the world of bits because that's where war is currently being conducted?
...
Fifty years ago, physicists, engineers, and mathematicians finished a 50-year sprint that shipped the transistor, the laser, fiber optics, the communication satellite, the telephone, and the UNIX operating system, garnering nine nobel prizes and laying the foundation for the personal computer. Bell Labs, a spinoff R&D lab of AT&T, may take the cake as the most successful science and technology project known to history. They were able to do this, not because they were of different genetic makeup, but because they had access to healthy consensus-making machines, allowing for wide, cross-disciplinary collaboration, in big part motivated by the threat of Germany and the Sovjet Union.
