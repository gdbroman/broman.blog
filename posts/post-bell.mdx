...
But trying to recreate Bell Labs in 2023 would be a mistake for multiple reasons. The obvious being that the frontier is temporal: The telephone is no longer the frontier – and as we stipulate in this article, neither is software. But the far more pernicious reason is that the institutions that Bell Labs relied on are dead. War is no longer a motivator, academia is a credentialism industry, and regulation has made it harder to innovate anywhere that isn't online. And while there is some value in trying to reform from the inside in Washington, DC, or Cambridge, MA, it's no doubt harder than starting anew. In this article we explore what such new institutions might look like.
