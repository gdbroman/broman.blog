...
Viewing the network state as a solution to the adventure/embodiment-problem is far more inspiring than using it merely as a solution to regulation and politics.
