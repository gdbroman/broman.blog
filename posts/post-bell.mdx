...
With a spineless government, and a tracked academia, much talent finds itself instead drawn to more vital institutions like Silicon Valley. And this in part provides a sociological explanation of the stagnation of the physical sciences. At one point Silicon Valley functioned as a rebel haven, but its spirit has now almost been completely extinguished. A big issue is that it tried to formalize Bell Labs. But the far more pernicious issue is that has been living off of the same set of 50-year old ideas produced by research institutions that are now dead. And while it's possible to reform from the inside of Silicon Valley (or even Washington, DC, and Cambridge, MA), it's at this point more likely that new ideas will come from outside.
