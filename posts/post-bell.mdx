---
title: "Moving Beyond the Bellian Age"
date: "2023-09-25"
description: "Reviving the Future with Human Nature"
image: "/frontier/bell-labs-ny-hq.png"
draft: true
---

In the end of 20th century Prometheus was put to sleep. The first strike was physical, with the invention of the atom bomb; and the second was virtual, with the booming commercialization of the personal computer. It's common to focus on the paralyzing effect these two events have had on geopolitics, but here we consider their impact on the very systems that led to their creation. The 21st century is what happens when you remove the two natural motivators for innovation: violence and curiosity. So the question becomes not whether we can outdo the 20th century, but whether we can outdo the 20th century without war.
