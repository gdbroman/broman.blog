...
date: "2023-09-16"
description: "Breaking Through Institutional Decay With the Pursuit of Glory"
...
Young men used to be able to exercise their adventourous spirit in war or sailing the seas. Or their intellectual hunger in academia. But now all the seas are explored, the wars are fake, and a degree doesn't mean anything anymore. The litterally me phenomenon represents the frustration of this missing outlet.

In contrast to Bell Labs, the internet isn't teleological (or perhaps the facilitattion of unrestricted flow of information). But it isn't rooted in any need like survival or virtue like glory.

Furthermore, the problem with the internet is that it's virtual and humans are embodied, we need to interact in physical space to use our full potential. So the internet is not enough, we need to think about institutions in physical space.
